-- 1 ----------------------------------------
-- Crear las tablas e insertar datos de ejemplo para una base de datos de un sistema bancario.
-- Ejecutar desde CREATE TABLE... hasta el fin de las INSERT INTO...
...
-- Si se ejecuta desde el BEGIN hasta el COMMIT recibiremos un error y la transaccion no se completará.
-- Se debe hacer un ROLLBACK para revertir todos los cambios realizados hasta el momento.
-- Commentar la linea SELECT 1/0; y volver a ejecutar la transacción, esta vez si se ejecutará y se aplicará el cambio.
